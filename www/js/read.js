...
function populateGuest(tx) {
  ...
  tx.executeSql(
    "CREATE TABLE IF NOT EXISTS guest (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, title TEXT NOT NULL, firstname TEXT NOT NULL, lastname TEXT NOT NULL, tableno INTEGER, eventname TEXT NOT NULL)"
  );
  tx.executeSql(
    'INSERT INTO guest(title, firstname, lastname, tableno, eventname) VALUES ("", "", "", , "")'
  );
  alert("table created");
}
